...
void main () {
  ...
  gl_FragColor = c;
}`;const qe=""+new URL("waternormals-35viC6WO.jpg",import.meta.url).href,Ye=s=>(Se("data-v-5fdef645"),s=s(),Me(),s),Qe={id:"ocean",class:"webgl"},Je={id:"ocean-webgl",class:"webgl-3d"},$e={class:"loading"},et=Ye(()=>I("p",null,"Loading · · ·",-1)),tt={class:"process"},it=ve({__name:"index",setup(s){class i extends Ve{constructor(o,t={}){super(o,t);A(this,"sky");A(this,"water");A(this,"island");A(this,"animateId2");A(this,"gltfLoader");this.myDraw()}initModel(){this.gltfLoader=new je(this.manager),this.gltfLoader.load("./models/island.glb",o=>{const t=o.scene;t.traverse(a=>{a.isMesh&&(a.material.metalness=.4,a.material.roughness=.6)}),t.position.set(0,-5.5,0),t.scale.set(80,80,80),this.island=t,this.scene.add(t)}),this.gltfLoader.load("./models/flamingo.glb",o=>{const t=o.scene.children[0];t.scale.set(.4,.4,.4),t.position.set(-180,80,-160),t.rotation.set(.2,-.8,0),this.scene.add(t);const a=t.clone();a.scale.set(.4,.4,.4),a.position.set(-60,75,-260),a.rotation.set(.2,-.8,0),this.scene.add(a);const p=new te(t);p.clipAction(o.animations[0]).setDuration(1.2).play(),this.mixers.push(p);const g=new te(a);g.clipAction(o.animations[0]).setDuration(1.8).play(),this.mixers.push(g)})}initSky(){this.sky=new G,this.sky.scale.setScalar(1e4),this.scene.add(this.sky);const o=this.sky.material.uniforms;o.turbidity.value=20,o.rayleigh.value=2,o.mieCoefficient.value=.005,o.mieDirectionalG.value=.8}initSea(){const o=new Ae(1e4,1e4);this.water=new Oe(o,{textureWidth:512,textureHeight:512,waterNormals:new ie().load(qe,t=>{t.wrapS=oe,t.wrapT=oe}),sunDirection:new l,sunColor:16777215,waterColor:29439,distortionScale:4,fog:this.scene.fog!==void 0}),this.water.rotation.x=-Math.PI/2,this.scene.add(this.water)}initSun(){const o=new l,t=new We(this.renderer),a=ne.degToRad(88),p=ne.degToRad(180);o.setFromSphericalCoords(1,a,p),this.sky.material.uniforms.sunPosition.value.copy(o),this.water.material.uniforms.sunDirection.value.copy(o).normalize(),this.scene.environment=t.fromScene(this.sky).texture;const g=new ke(16777215,1.2,2e3);g.color.setHSL(.995,.5,.9),g.position.set(0,45,-5e3);const P=new ie,C=P.load(He),y=P.load(Ke),n=new N;n.addElement(new B(C,600,0,g.color)),n.addElement(new B(y,60,.6)),n.addElement(new B(y,70,.7)),n.addElement(new B(y,120,.9)),n.addElement(new B(y,70,1)),g.add(n),this.scene.add(g)}initTorus(){const o=new q({side:Ue,transparent:!0,uniforms:{},vertexShader:Xe,fragmentShader:Ze}),t=new Ne(200,10,50,100),a=new k(t,o);a.opacity=.1,a.position.set(0,-80,-650),a.scale.set(1.8,1.8,1.8),this.scene.add(a)}initManager(){const o={x:41,y:257,z:447};super.initManager(f,o)}animate2(){this.animateId2=requestAnimationFrame(this.animate2.bind(this)),this.water.material.uniforms.time.value+=2/60;const o=this.clock.getDelta();this.mixers&&this.mixers.forEach(t=>{t.update(o)})}initCamera(){super.initCamera(),this.camera.near=1,this.camera.updateProjectionMatrix(),this.camera.position.set(373,777,1227)}initControls(){super.initControls(),this.controls.target.set(0,0,0),this.controls.maxPolarAngle=1.4,this.controls.minDistance=180,this.controls.maxDistance=1500,this.controls.enabled=!0}initRender(){super.initRender({x:41,y:257,z:447}),this.renderer.toneMapping=Ie}myDraw(){super.draw(),this.initManager(),this.initSea(),this.initSky(),this.initSun(),this.initTorus(),this.initModel(),this.animate2()}destroyed(){super.destroyed(e.value),cancelAnimationFrame(this.animateId2)}}const e=j(null),v=j({width:0,height:0}),f=j({loadingProcess:0,sceneReady:!1,loadingTimeout:null});function b(){const h=document.getElementById("ocean-webgl");v.value={width:h.offsetWidth,height:h.offsetHeight},e.value=new i(h,{logarithmicDepthBuffer:!1})}return de(()=>{b()}),me(()=>{e.value&&e.value.destroyed(),f.value={loadingProcess:0,loadingTimeout:null,sceneReady:!1},e.value=null}),(h,R)=>(we(),fe("div",Qe,[I("div",Je,[he(ge(Ge,null,{default:xe(()=>[I("div",$e,[et,I("span",tt,ye(f.value.loadingProcess)+"%",1)])]),_:1},512),[[pe,f.value.loadingProcess!=100]])])]))}}),st=be(it,[["__scopeId","data-v-5fdef645"]]);export{st as default};
